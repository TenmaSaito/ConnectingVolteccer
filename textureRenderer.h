...
public:
	...
	void Uninit(void);
	void Update(void);
	void BeginRenderer(const D3DXVECTOR3 &posV, const D3DXVECTOR3 &posR, const D3DXVECTOR3 &vecU);
	LPDIRECT3DTEXTURE9 GetTexture(void) const { return m_pTextureMT; }
	D3DXVECTOR3 GetPosV(void) const { return m_posV; }
	D3DXVECTOR3 GetPosR(void) const { return m_posV; }
	D3DXVECTOR3 GetVecU(void) const { return m_vecU; }
